...
This time cose is in addition to the cost of the certificate, if any.

In contrast, setting up an onion site takes a few minutes and costs
nothing.  Even when the process of learning how to create a PGP key
and signature is taken into account, the time investment is
dramatically less than with the X.509 public key infrastructure.
