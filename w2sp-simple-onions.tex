...
inherently not humanly meaningful unless one invests a lot of time and
effort.  And to get a specific domain name of choice is
technologically infeasible even then. The signed-onion technique
...
Second, many intended users of the site may not have Tor installed.
...
Third, traditional search and indexing engines such as google do
...
TLS. Assuming Let's Encrypt is successful, and
HTTPS at no additional cost is increasingly available from ISPs,
we can also envisage incorporation with TLS signatures as
Facebook and others have done.
